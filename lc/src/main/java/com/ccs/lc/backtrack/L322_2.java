...
public class L322_2 {
    ...
    private boolean contain(String key,String value){

        Map<String, Integer> innerMap = map.get(key);
        if(innerMap == null){
            return false;
        }else{
            if(innerMap.get(value)!=null && innerMap.get(value)>=1){
                return true;
            }
        }
        return false;
    ...
    private void add(String key,String value){
        ...
        if(innerMap == null){
            ...
            if(innerMap.get(value)==null){
                ...
                innerMap.put(value,innerMap.get(value)+1);
            }
        }
        map.put(key,innerMap);
    }
    private void remove(String key,String value){
        Map<String, Integer> stringIntegerMap = map.get(key);
        if(stringIntegerMap !=null){
            Integer i = stringIntegerMap.get(value);
            if(i ==null){
                return;
           }else{
               if(i==1){
